"""检索可追溯的本地资料：法规原文与待复核案例摘要分开，绝不补入仿真条款。"""
...
REGULATION_FILE = "deploy/ragflow/docs/real/coal_mine_safety_regulations/2025版煤矿安全规程_第九章冲击地压防治_节选.txt"
...
def retrieve_verified_knowledge(terms: list[str], root: Path = ROOT) -> RetrievalData:
    ...
    cases_path = root / "tests/fixtures/real_accident_cases.yaml"
